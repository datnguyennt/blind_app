...
class Toast {
  ...
  static void _createView(String msg, Color textColor, Color backgroundColor,
  ...
  static Container buildToastUI(BuildContext context, String msg,
      Color textColor, Color backgroundColor, double borderRadius) {
    return Container(
